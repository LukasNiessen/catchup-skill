...
def _register_crontab(job: Dict[str, Any], runner_path: Path) -> str:
    ...
    description = cron_parse.describe_schedule(cron_parse.parse_cron_expression(schedule))
...
def _register_schtasks(job: Dict[str, Any], runner_path: Path) -> str:
    ...
    parsed = cron_parse.parse_cron_expression(schedule)
    schtasks_args = cron_parse.cron_to_schtasks_args(parsed)
    ...
    description = cron_parse.describe_schedule(parsed)
